...
import fragShader from '../../Shaders/OffsetWaves2D/Plane/frag.glsl?raw'
import vertShader from '../../Shaders/OffsetWaves2D/Plane/vert.glsl?raw'
...
const OffsetWaves2D = () => {
  ...
  useEffect(() => {
    if (!sheet) return
    const obj = sheet.object('OffsetWaves2D / Shader', {
